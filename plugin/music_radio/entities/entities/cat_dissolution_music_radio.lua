...
if ( SERVER ) then
	...
	function ENT:OnRemove( )
		netstream.Start( nil, "catherine.dissolution.plugin.musicRadio.StopMusic", self )
	...
	function ENT:PlayMusic( )
		netstream.Start( nil, "catherine.dissolution.plugin.musicRadio.PlayMusic", self )
	end
	...
	function ENT:ChangeVolume( )
		netstream.Start( nil, "catherine.dissolution.plugin.musicRadio.ChangeVolume", self )
	end
	...
	function ENT:ChangeMusic( )
		...
		netstream.Start( nil, "catherine.dissolution.plugin.musicRadio.ChangeMusic", self )
	...
	netstream.Hook( "catherine.dissolution.plugin.musicRadio.ChangeVolume", function( data )
	...
	netstream.Hook( "catherine.dissolution.plugin.musicRadio.ChangeMusic", function( data )
		if ( IsValid( data.soundEnt ) ) then
			data.soundEnt:Stop( )
			data.soundEnt = nil
			data.donotThink = true
			
			local timerID = "catherine.dissolution.plugin.musicRadio.ChangeMusicDelay." .. data:EntIndex( )
	...
	netstream.Hook( "catherine.dissolution.plugin.musicRadio.PlayMusic", function( data )
		data.donotThink = true
	...
	netstream.Hook( "catherine.dissolution.plugin.musicRadio.StopMusic", function( data )
		if ( IsValid( data.soundEnt ) ) then
			data.soundEnt:Stop( )
			data.soundEnt = nil
		end
